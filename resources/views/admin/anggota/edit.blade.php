    ...
    <div class="card">
      <div class="card-block">
        ...
        <form action="{{ route('anggota.update', $anggota->id) }}" enctype="multipart/form-data" method="POST">
          ...
          <div class="form-group">
            <label>Gambar</label>
            <input type="file" class="form-control" name="gambar" value="{{ $anggota->gambar }}" required>
          </div>
          ...
          <div class="form-group">
            <label>Alamat</label>
            <textarea required name="alamat" value="{{ $anggota->alamat }}" class="form-control"
              style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
          </div>
          <div class=" form-group">
            <label>Angkatan</label>
            <input type="number" class="form-control" name="angkatan" value="{{ $anggota->angkatan }}" required>
          </div>
